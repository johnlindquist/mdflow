...
3. Capture the affected UI at desktop (`1440x900`) and mobile (`390x844` and `320x568`) widths. Set the viewport before opening the page or reload after each viewport change; `StretchName` captures the window width when it mounts.
